        ...
        return `${validate_component(SplideSlide, "SplideSlide").$$render($$result, {}, {}, {
          ...
          default: () => {
            return `${validate_component(RolesCard, "RolesCard").$$render(
              ...
              {
                front: {
                  src: "/images/roles/Craftsman.webp",
                  title: "Craftsman"
                },
                back: {
                  title: "Craftsman",
                  text: `Craftsman invests in equipment and tools that are vital to gold miners. Players can rent these tools for mining, and Craftsman receives a steady rental income. Like land, the tools are NFTs, providing the owner with ownership of a unique digital asset.`
                }
              },
              {},
              {}
          ...
          default: () => {
            return `${validate_component(RolesCard, "RolesCard").$$render(
              ...
              {
                front: {
                  src: "/images/roles/Glebarch.webp",
                  title: "Glebarch"
                },
                back: {
                  title: "Glebarch",
                  text: `Glebarch owns entire islands that can be rented out or used to create large events and activities within the game. This is the most elite role with great passive income opportunities. By owning an island through NFT, Glebarch controls large tracts of virtual real estate, which creates additional demand among players.`
                }
              },
              {},
              {}
